...
import edu.hrbu.trace_backend_business.util.ExcelUtil;
...
public class FileServiceImpl implements FileService {
    ...
    public Result requestProductAddByExcel(MultipartFile file) {
        ...
        excelData.forEach(data -> {
            ...
            edu.hrbu.trace_backend_business.entity.po.ProductRecord insertProductRecord = edu.hrbu.trace_backend_business.entity.po.ProductRecord.builder()
    ...
    public Result requestApproachByExcel(MultipartFile file) {
        List<edu.hrbu.trace_backend_business.entity.excel.Approach> approaches = ExcelUtil.importExcel(
                file.getInputStream(),
                edu.hrbu.trace_backend_business.entity.excel.Approach.class
        );
        for (edu.hrbu.trace_backend_business.entity.excel.Approach approach : approaches) {
    ...
    public Result requestEntranceByExcel(MultipartFile file) {
        List<edu.hrbu.trace_backend_business.entity.excel.Entrance> entrances = ExcelUtil.importExcel(
                file.getInputStream(),
                edu.hrbu.trace_backend_business.entity.excel.Entrance.class
        );
        for (edu.hrbu.trace_backend_business.entity.excel.Entrance entrance : entrances) {
            DateTime operateTime = new DateTime(DateTime.now());

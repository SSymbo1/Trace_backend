...
import edu.hrbu.trace_backend_business.entity.dto.system.Role;
...
public class SystemServiceImpl implements SystemService {
    ...
    @Override
    public Result requestAccountAdd(edu.hrbu.trace_backend_business.entity.dto.system.Account account) {
        Integer currentAccountId = Integer.valueOf(JwtUtil.parseJWT(OnlineContext.getCurrent()).getSubject());
        QueryWrapper<Account> existAccountWrapper = new QueryWrapper<>();
        existAccountWrapper.eq("username", account.getUsername());
        edu.hrbu.trace_backend_business.entity.po.Role role = roleMapper.selectById(account.getRole());
    ...
    public Result requestAccountStatueSet(AccountStatue statue) {
        Account updateAccountStatue = null;
        if (statue.getDel().equals(1)) {
            updateAccountStatue = Account.builder()
                    .aid(statue.getAid())
                    .del(statue.getDel())
                    .ban(1).build();
        } else {
        ...
        if (statue.getBan().equals(0)) {
            Account account = accountMapper.selectById(statue.getAid());
            QueryWrapper<edu.hrbu.trace_backend_business.entity.po.Role> roleQueryWrapper = new QueryWrapper<>();
    ...
    @Override
    public Result requestAccountEdit(edu.hrbu.trace_backend_business.entity.dto.system.Account account) {
        edu.hrbu.trace_backend_business.entity.po.Role role = roleMapper.selectById(account.getRole());
        if (role.getBan().equals(1)) {
            return Result
                    .fail(Message.CANNOT_EDIT_BAN_ROLE_ACCOUNT.getValue())
        ...
        AccountInfo updateAccountInfo = AccountInfo.builder()
                ...
                .address(account.getAddress())
                .zipCode(account.getZipCode()).build();
        Account exist = accountMapper.selectById(account.getAid());
        if (exist.getUsername().equals(account.getUsername())) {
            ...
            QueryWrapper<Account> existWrapper = new QueryWrapper<>();
    ...
    public Result requestDisableAllAccount(Able able) {
        ...
        Account updateBan = Account.builder()
                .ban(1).build();
    ...
    public Result requestEnableAllAccount(Able able) {
        ...
        if (!accounts.isEmpty()) {
            for (Account account : accounts) {
                edu.hrbu.trace_backend_business.entity.po.Role role = roleMapper.selectById(account.getRid());
                if (role.getBan().equals(1)) {
    ...
    public Result requestEnterpriseInfoPaged(EnterpriseQuery query) {
        IPage<edu.hrbu.trace_backend_business.entity.po.Enterprise> page = new Page<>(
    ...
    @Override
    public Result requestEnterpriseAdd(edu.hrbu.trace_backend_business.entity.dto.system.Enterprise enterprise) {
        Integer currentAccountId = Integer.valueOf(JwtUtil.parseJWT(OnlineContext.getCurrent()).getSubject());
        QueryWrapper<edu.hrbu.trace_backend_business.entity.po.Enterprise> existWrapper = new QueryWrapper<>();
        ...
        edu.hrbu.trace_backend_business.entity.po.Enterprise insertEnterprise = edu.hrbu.trace_backend_business.entity.po.Enterprise.builder()
    ...
    @Override
    public Result requestEnterpriseEdit(edu.hrbu.trace_backend_business.entity.dto.system.Enterprise enterprise) {
        edu.hrbu.trace_backend_business.entity.po.Enterprise updateEnterprise = edu.hrbu.trace_backend_business.entity.po.Enterprise.builder()
                ...
                .ilk(enterprise.getIlk())
                .zipCode(enterprise.getZipCode()).build();
        edu.hrbu.trace_backend_business.entity.po.Enterprise exist = enterpriseMapper.selectById(enterprise.getEid());
    ...
    public Result requestRoleStatueSet(RoleStatue statue) {
        edu.hrbu.trace_backend_business.entity.po.Role updateRoleStatue = null;
        if (statue.getDel().equals(1)) {
            updateRoleStatue = edu.hrbu.trace_backend_business.entity.po.Role.builder()
                    .rid(statue.getRid())
                    .del(statue.getDel())
                    .ban(1).build();
        } else {
    ...
    public Result requestRoleInfoPaged(RoleQuery query) {
        IPage<edu.hrbu.trace_backend_business.entity.po.Role> page = new Page<>(
                query.getCurrentPage(), query.getPageSize()
        );
        Map<String, Object> condition = getRoleInfoSearchCondition(query);
        IPage<edu.hrbu.trace_backend_business.entity.po.Role> data = roleMapper.selectRoleByCondition(page, condition);
        data.getRecords().forEach(record -> record.setMenueList(Arrays.asList(record.getMenues().split(","))));
        return Result
    ...
    public Result requestRoleEdit(Role role) {
        ...
        edu.hrbu.trace_backend_business.entity.po.Role updateRole = edu.hrbu.trace_backend_business.entity.po.Role.builder()
                .rid(role.getRid())
                .name(role.getName())
                .memo(role.getMemo()).build();
        edu.hrbu.trace_backend_business.entity.po.Role exist = roleMapper.selectById(role.getRid());
        if (exist.getName().equals(role.getName())) {
            ...
            QueryWrapper<edu.hrbu.trace_backend_business.entity.po.Role> existWrapper = new QueryWrapper<>();
    ...
    public Result requestRoleAdd(Role role) {
        ...
        edu.hrbu.trace_backend_business.entity.po.Role addRole = edu.hrbu.trace_backend_business.entity.po.Role.builder()
                .name(role.getName())
    ...
    public Result requestEnableAllRole(Able able) {
        ...
        QueryWrapper<edu.hrbu.trace_backend_business.entity.po.Role> queryWrapper = new QueryWrapper<>();
        queryWrapper
                .ne("rid", 1)
                .and(ban -> ban.ne("ban", 0))
                .and(del -> del.ne("del", 1));
    ...
    public Result requestSensitiveEnterpriseInfoPaged(String keyword, Integer currentPage, Integer pageSize) {
        ...
        IPage<EnterpriseOperate> enterpriseOperateIpage = enterpriseOperateMapper.selectEnterpriseOperateByCondition(
                page, keyword
        );

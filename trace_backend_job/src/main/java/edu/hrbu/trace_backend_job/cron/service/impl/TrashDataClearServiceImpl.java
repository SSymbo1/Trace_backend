package edu.hrbu.trace_backend_job.cron.service.impl;

import cn.hutool.core.date.DateTime;
import cn.hutool.core.io.FileUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import edu.hrbu.trace_backend_job.cron.service.TrashDataClearService;
...
public class TrashDataClearServiceImpl implements TrashDataClearService {
    ...
    public void removeUnusedAvatar() {
        ...
        File[] avatars = FileUtil.ls(
                edu.hrbu.trace_backend_job.util.FileUtil.getSystemPath() + Folder.AVATAR.getValue()
        );
    ...
    public void removeUnusedGoodsPhoto() {
        ...
        File[] photos = FileUtil.ls(
                edu.hrbu.trace_backend_job.util.FileUtil.getSystemPath() + Folder.GOODS.getValue()
        );

package edu.hrbu.trace_backend_job.strategy.impl.farm;
...
import edu.hrbu.trace_backend_job.strategy.FarmAnalysisStrategy;
...
public class DayFarmOperation implements FarmAnalysisStrategy {
    ...
    private ProvinceData getApproachFarmFromDataList(FarmQuery query) {
        ...
        for (edu.hrbu.trace_backend_job.entity.enums.Province province : edu.hrbu.trace_backend_job.entity.enums.Province.values()) {
        ...
        for (ApproachCount count : countEntrance) {
            ...
            for (Approach approach : entrances) {
                ...
                if (enterprise.getAddress().contains(edu.hrbu.trace_backend_job.entity.enums.Province.HEILONGJIANG.getKey())) {
                    entranceEnter++;
                    enter++;
                } else {
                    entranceOuter++;

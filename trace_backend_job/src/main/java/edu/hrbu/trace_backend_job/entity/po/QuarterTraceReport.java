...
import edu.hrbu.trace_backend_job.entity.po.json.ReportApproach;
import edu.hrbu.trace_backend_job.entity.po.json.ReportEnterprise;
import edu.hrbu.trace_backend_job.entity.po.json.ReportEntrance;
...
@AllArgsConstructor
@NoArgsConstructor
public class QuarterTraceReport {

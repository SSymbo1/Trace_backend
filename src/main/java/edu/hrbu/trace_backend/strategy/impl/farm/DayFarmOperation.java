...
import edu.hrbu.trace_backend.strategy.FarmAnalysisStrategy;
...
public class DayFarmOperation implements FarmAnalysisStrategy {
    ...
    private ProvinceData getApproachFarmFromDataList(FarmQuery query) {
        ...
        for (edu.hrbu.trace_backend.entity.enums.Province province : edu.hrbu.trace_backend.entity.enums.Province.values()) {
        ...
        for (ApproachCount count : countEntrance) {
            ...
            for (Approach approach : entrances) {
                ...
                if (enterprise.getAddress().contains(edu.hrbu.trace_backend.entity.enums.Province.HEILONGJIANG.getKey())) {
                    entranceEnter++;
                    enter++;
                } else {
                    entranceOuter++;

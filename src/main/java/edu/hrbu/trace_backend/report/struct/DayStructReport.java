...
import edu.hrbu.trace_backend.entity.dto.analysis.EnterpriseTypeCount;
...
import edu.hrbu.trace_backend.entity.po.json.PointFocus;
import edu.hrbu.trace_backend.entity.po.json.PointRate;
import edu.hrbu.trace_backend.entity.po.json.PointStruct;
import edu.hrbu.trace_backend.mapper.EnterpriseMapper;
import edu.hrbu.trace_backend.mapper.ImportantEnterpriseMapper;
import edu.hrbu.trace_backend.mapper.StatisticsMapper;
...
@Slf4j
@Component("DayStruct")
public class DayStructReport implements Report {
    ...
    public Result generateReport(ReportQuery query) {
        String annotation = applicationContext.getBeanNamesForType(DayStructOperation.class)[0];
